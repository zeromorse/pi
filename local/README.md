...
自研 pi 用户级 skill 本体放在这里,经 `~/.pi/agent/skills/<名称>` 符号链接暴露为全局技能(parallel-dispatch、blog-sync-local、pi-usage-reflection)。
...
| `pi-usage-reflection/` | pi 使用反思 skill(会话复盘报告) + 每日定时脚本 | [README.md](pi-usage-reflection/README.md) |
