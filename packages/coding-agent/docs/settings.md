...
| `defaultFlashProvider` | string | None | Provider of the flash (lightweight) model toggled via `/flash`; project overrides global. |
| `defaultFlashModel` | string | None | Model ID of the flash (lightweight) model toggled via `/flash`; project overrides global. |
